...
require (
	...
	github.com/Octops/agones-event-broadcaster v0.4.0
...
//https://github.com/googleforgames/agones/issues/3341
require github.com/joonix/log v0.0.0-20180502111528-d2d3f2f4a806 // indirect
